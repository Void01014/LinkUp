            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" style="height: calc(100vh - 180px);">
                <div class="flex h-full">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="ml-2 px-2 py-0.5 bg-gradient-to-r from-green-400 to-blue-500 text-white text-xs font-bold rounded-full">
                    ...
                    <div class="flex-1 flex flex-col">
                        ...
                        <!-- Messages Area -->
                        @livewire('chat.chat-list', ['user-id' => $user->id,
                        ...
                        <div class="p-4 border-t border-gray-200 bg-white">
                            <form action="/chat/{{ $activeConversation->id }}/send" method="POST" class="flex gap-3">
                                @csrf
                                ...
                                <input 
                                    ...
                                    required
                                >
                                <button type="submit" class="p-3 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-full hover:shadow-lg transition flex-shrink-0">
                        ...
                        <div class="flex-1 flex items-center justify-center bg-gray-50">
                            <div class="text-center">
                                <div class="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-green-100 to-blue-100 rounded-full flex items-center justify-center">
