                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <input type="text" placeholder="Search friends..."
                                    class="px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 transition">
                            </div>
                                ...
                                @forelse($friends as $request)
                                    @if ($request->status == 'pending')
                                        <div
                                            ...
                                            <div class="flex gap-2">
                                                <button
                                                    class="flex-1 bg-gradient-to-r from-green-400 to-blue-500 text-white py-2 px-3 rounded-lg text-sm font-medium hover:shadow-lg transition">
                                                    Accept
                                                </button>
                                                <button
